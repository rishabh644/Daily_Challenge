...
public:
    ...
    string numberToWords(int num)
    {
       ...
       // Arrays tp store wprds for numbers less than 10,20 and 100
       ...
       // Call the helper function to start the conversation
...
private:
   ...
   // Handles numbers based on their ranges: < 10, <20, <100, <1000,<1000000,<1000000000 and >= 10000000000
